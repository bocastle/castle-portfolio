...
const LOGS_ARTICLES: GitHubLogsArticleMeta[] = [
  {
    ...
    description:
      "코드 변경이 테스트, 빌드, 배포를 거쳐 서비스에 반영되는 과정을 운영 검증 관점에서 정리했습니다.",
  ...
  },
  {
    ...
    slug: "api-gateway",
    title: "API Gateway 라우팅과 인증 흐름",
    description:
      "인증, 라우팅, 트래픽 제어를 한 지점에서 다루는 API Gateway의 역할을 서비스 경계 관점에서 정리했습니다.",
  ...
  },
  {
    ...
    slug: "cors",
    title: "CORS 오류를 API 경계에서 보는 법",
    description:
      "브라우저와 백엔드 API가 만나는 지점에서 CORS 오류가 발생하는 이유와 검증 순서를 정리했습니다.",
  ...
  },
  {
    ...
    slug: "db-replication",
    title: "MySQL Replication 운영 포인트",
    description:
      "MySQL InnoDB 기준으로 읽기 분산, 복제 지연, 장애 대응을 함께 고려하는 데이터 운영 포인트를 정리했습니다.",
  ...
  },
  {
    ...
    description:
      "JPA 조회 코드가 실제 SQL과 성능 문제로 이어지는 흐름을 추적하고 최적화 기준을 정리했습니다.",
  ...
  },
  {
    ...
    title: "인덱스 선택과 실행 계획",
    description:
      "쿼리 성능을 실행 계획과 데이터 접근 패턴으로 확인하며 인덱스 선택 기준을 정리했습니다.",
  ...
  },
  {
    ...
    title: "React Error Boundary 장애 격리",
    description:
  ...
  },
  {
    ...
    title: "Zendesk Guide i18n 제약 우회",
    description:
  ...
  },
  {
    ...
    slug: "goroutine",
    title: "Go goroutine 동시성 설계",
    description:
      "Go의 goroutine을 서버 작업 분산과 동시성 설계 관점에서 정리했습니다.",
