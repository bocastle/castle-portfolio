...
export default async function CategoriesPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl items-start max-lg:w-full max-md:w-full max-sm:w-full flex flex-col md:gap-5 md:my-4 sm:gap-5 max-lg:items-center max-md:items-center max-sm:items-center">
