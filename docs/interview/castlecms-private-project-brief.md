...
1. API 목록과 주요 요청/응답 예시를 비밀값 없이 별도 문서로 정리합니다.
2. 권한 흐름을 Mermaid 다이어그램으로 추가합니다.
3. JUnit/Jest 검증 범위를 표로 정리합니다.
4. 공개 포트폴리오 프로젝트 카드에서 이 문서를 참고해 문구를 더 짧고 선명하게 다듬습니다.
