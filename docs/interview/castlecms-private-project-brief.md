# castleCms private 프로젝트 면접 설명 자료
...
- 면접에서는 "AI가 만든 프로젝트"가 아니라 요구사항 정의, 구조 설계, 구현, 테스트, 화면 QA를 직접 닫은 풀스택 사례로 말합니다.
...
- `docs/interview/castlecms-api-brief.md`의 API 흐름과 요청/응답 예시
...
1. 실제 면접 질문을 받은 뒤 답변이 길어진 부분을 더 짧게 다듬습니다.
